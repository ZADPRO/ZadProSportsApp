import { IonBackButton, IonButton, IonButtons, IonContent, IonHeader, IonPage, IonTitle, IonToolbar, useIonToast } from "@ionic/react";
...
const ProfileScreen = () => {
    ...
    const fetchData = async () => {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/v1/userRoutes/listProfileData`, {
            headers: {
                        ...
                        loading ? (
                            ...
                            >
                                ...
                                <div className="mt-[1rem] px-[1rem]">
                                    <label htmlFor="firstName" className="text-[#000] text-[0.9rem] font-[poppins]">First Name</label>
                                    <InputText
                                        type="firstName"
                                ...
                                <div className="mt-[0.9rem] px-[1rem]">
                                    <label htmlFor="lastName" className="text-[#000] text-[0.9rem] font-[poppins]">Last Name</label>
                                    <InputText
                                        id="lastName"
                                ...
                                {/* Date of Birth */}
                                <div className="mt-[0.9rem] px-[1rem]">
                                    <label className="text-[#000] text-[0.9rem] font-[poppins]">Date of Birth</label>
                                    <Calendar
                                        value={dob}
                                        onChange={(e: any) => {
                                ...
                                {/* Mobile */}
                                <div className="mt-[0.9rem] px-[1rem]">
                                    <label htmlFor="mobile" className="text-[#000] text-[0.9rem] font-[poppins]">Mobile Number</label>
                                    <InputText
                                        id="mobile"
                                ...
                                {/* Email */}
                                <div className="mt-[0.9rem] px-[1rem]">
                                    <label htmlFor="email" className="text-[#000] text-[0.9rem] font-[poppins]">Email</label>
                                    <InputText
                                        id="email"
                                ...
                                <div className="flex justify-center mt-[2rem] mb-[3rem]">
                                    <IonButton
                                        ...
                                        type="submit"
                                        className="custom-ion-button w-[90%] text-[#fff] text-[0.9rem] font-[poppins]">Save Profile</IonButton>
                                </div>
                            </form>
                        )
                    }
