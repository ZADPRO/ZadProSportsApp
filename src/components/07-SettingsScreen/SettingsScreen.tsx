    ...
    <IonPage>
      ...
      <IonContent>
        <div className="bg-[#fff] w-[100%] overflow-auto px-[1rem] py-[1rem]">
          <div
            className="w-[100%] flex gap-[1rem] items-center bg-[#a9d6ff] rounded-[10px] p-[10px]"
            style={{ border: "1.5px solid #0377de" }}
          >
            <div>
              <div
                className="w-[5rem] h-[5rem] rounded-[50%] bg-[#f8d110] flex justify-center items-center"
                onClick={() => {
            ...
            <div>
              <div className="text-[1rem] font-[poppins] text-[#282828] font-[600]">
                Hello👋,
              </div>
              <div className="text-[1rem] font-[poppins] text-[#282828] font-[600]">
                {name}!
          ...
          <div
            className="w-[100%] mt-[0.8rem] bg-[#f7f7f7] rounded-[10px] p-[10px]"
          ...
          >
            ...
            >
              <div className="text-[0.9rem] font-[poppins] text-[#282828] font-[500] flex gap-[1rem]">
                <span>
                  <IoMdInformationCircleOutline className="text-[1.5rem]" />
                </span>
                About Us
              </div>
              <div>
            ...
            >
              <div className="text-[0.9rem] font-[poppins] text-[#282828] font-[500] flex gap-[1rem]">
                <span>
                  <MdOutlinePrivacyTip className="text-[1.5rem]" />
                </span>
                Privacy Policy
              </div>
              <div>
            ...
            <div className="mt-[0.6rem] mb-[0.4rem] flex justify-between">
              <div
                onClick={() => {
                  localStorage.clear();
                  ionRouter.push("/login", "root", "replace"); // Navigate and reset history stack
                }}
                className="text-[0.9rem] font-[poppins] text-[#fff] bg-[#ff1111] pl-[0.5rem] pt-[0.5rem] pb-[0.2rem] w-[100%] font-[500] flex gap-[1rem] rounded-[10px]"
              >
                <span>
